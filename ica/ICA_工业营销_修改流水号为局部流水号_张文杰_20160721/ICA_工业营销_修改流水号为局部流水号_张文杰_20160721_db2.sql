ALTER TABLE ICA_ICOM_EXT add column SHORT_CODE VARCHAR(2);
...
ALTER TABLE "ICA_PLAN_HISOPIN" 
    ADD CONSTRAINT "ICA_PLAN_HISOPIN_PK" PRIMARY KEY ("OPINION_ID");
...
ALTER TABLE "ICA_PLAN_HISOPIN_ITEM" 
    ADD CONSTRAINT "ICA_PLAN_HISOPIN_ITEM_PK" PRIMARY KEY ("OPINION_ID","ITEM_ID");