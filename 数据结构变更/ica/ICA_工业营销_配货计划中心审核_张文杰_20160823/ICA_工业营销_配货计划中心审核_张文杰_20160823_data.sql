DELETE FROM PUB_URLS WHERE FUNCTION_CODE='ica_allotaudit';
DELETE FROM PUB_ROLE_OPERATION WHERE OPERATION_CODE IN (SELECT OPERATION_CODE FROM PUB_OPERATIONS WHERE FUNCTION_CODE='ica_allotaudit');
DELETE FROM PUB_OPERATIONS WHERE FUNCTION_CODE='ica_allotaudit';
DELETE FROM PUB_FUNCTIONS WHERE FUNCTION_CODE='ica_allotaudit';
