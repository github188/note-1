...
<p style="width:50px;height:300px;background-color:#0000FF;" id="t">如果为 p 设置了 scrollTop，这些内容可能不会完全显示。</p>
...
注意.如果对象是包括在一个p中时,此p不会被当做是此对象的上级层,(即对象的上级层会跳过p对象)上级层是Table时则不会有问题.
